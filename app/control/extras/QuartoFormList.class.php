<?php
/**
 * QuartoFormList Form List
 * @author  <your name here>
 */
class QuartoFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('form_Quarto');
        $this->form->setFormTitle('Quarto');
        

        // create the form fields
        $id = new TEntry('id');
        $n_quarto = new TEntry('n_quarto');
        ...
        $column_n_quarto = new TDataGridColumn('n_quarto', 'N Quarto', 'left');
        ...
        $this->datagrid->addColumn($column_n_quarto);
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Quarto
            $repository = new TRepository('Quarto');
            $limit = 10;
            // creates a criteria
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new Quarto;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('app'); // open a transaction
                $object = new Quarto($key); // instantiates the Active Record
